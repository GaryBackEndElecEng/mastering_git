...
## To publish and OR sync your push events with your branch, you:

git push --set-upstream origin 'branch name that you are on'

## OR

git push -u origin branch-name ( your branch= "branch-name")

## This sets up your local branch to the remote branch-name on the repo. This allows you to do the work related that branch until merges.
